      ...
      <div className="col-span-3">
        <div className="flex flex-col text-xs justify-between">
          ...
          <div className='w-56 grid grid-cols-3 px-2 mt-4 justify-center items-center'>
            <AiFillMinusSquare className='col-span-1 text-xl hover:2xl cursor-pointer duration-75'/>
            <span className='col-span-1 text-xl font-bold'>1</span>
            <AiFillPlusSquare className='col-span-1 text-xl hover:2xl cursor-pointer duration-75'/>
          </div>
        </div>
      </div>
    </div>
