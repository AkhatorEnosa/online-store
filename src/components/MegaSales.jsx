...
const MegaSales = () => {
  const[countdown, setCountDown] = useState("");
    ...
    var proposedDate = new Date("Nov 11, 2022 12:46 :00");
        ...
        {distance < 0 ? 
          <div className="flex flex-col ml-10 z-50">
            ...
            {/* <h1 className='mt-6 text-center lg:text-3xl text-2xl tracking-tight font-bold uppercase'>{countdown}</h1> */}
              <button className="px-32 py-3 mx-auto w-fit rounded-lg hover:bg-[#fe4343] hover:text-black bg-[#000] text-white my-4 shadow-md duration-300">
                Explore
              </button>
          </div> : 
          <div className="flex flex-col ml-10 z-50">
            ...
            <h1 className='lg:text-7xl text-3xl tracking-tight font-extrabold text-center'>Mega Shopping Fiesta</h1>
            <h1 className='mt-6 text-center lg:text-3xl text-2xl tracking-tight font-bold uppercase'>{countdown}</h1>
              {/* <button className="hidden px-8 py-2 hover:bg-[#fe4343] hover:text-black bg-[#000] text-white my-4 shadow-md duration-300">
                Shop Now
              </button> */}
          </div>
          }
