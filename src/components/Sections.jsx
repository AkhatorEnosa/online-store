...
const Sections = () => {
  return (
    <div className='grid grid-cols-3 md:p-6 p-2 pb-3'>
      <div className="flex flex-col md:m-6 -mb-2 md:p-4 p-2 -pb-5 w-full md:border-l-2 border-yellow-200/20">
        ...
        <div className="flex md:flex-row flex-col mb-12 md:items-start align-middle justify-center md:justify-start items-center text-center">
      ...
      <div className="flex flex-col md:m-6 -mb-2 md:p-4 p-2 -pb-5 w-full md:border-l-2 border-yellow-200/20">
        <h1 className='uppercase border-b-2 border-[#fed243] w-fit pr-5 mb-10 '>Featured</h1>
